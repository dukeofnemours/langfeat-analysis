...
for local_path in (PROJECT_ROOT, PROJECT_ROOT / "utils"):
    if str(local_path) not in sys.path:
        sys.path.insert(0, str(local_path))

from registry import Action, register_event  # noqa: E402
from scripts.audio.preproc import stimulus_frame_grid  # noqa: E402
...
class TranscriptGenerator:
    ...
    def _load_models(self) -> None:
        ...
        print("Initializing transcription and alignment models...")
    ...
    def transcribe_audio(
        ...
        destination = destination_dir / self.output_filename_template.format(
            stimulus=audio_path.stem
        )
    ...
    def _transcribe_with_mlx(self, audio_path: Path) -> dict[str, Any]:
        ...
        print(f"Normalized sample rate: {sr}")
        print(f"Audio duration: {duration:.3f}s")
        print(f"Chunk duration: {self.chunk_seconds:.3f}s")
    ...
    def _transcribe_with_pytorch(
        ...
        or more of audio.
        """
        print(f"Transcribing with PyTorch on {self.backend}...")
...
class TextEmbedderGrid:
    ...
    def _read_textgrid(self) -> list[list[Any]]:
        ...
        content = self.annotation_path.read_text(encoding="utf-8-sig")
    ...
    def _build_record(
        ...
        metadata = {
            ...
            "source_extractor": "scripts.text.preproc",
