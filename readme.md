...
Release 0.2.4 targets Python 3.11 because upstream OpenL3 0.4.2 does not build
...
pipx install \
  'langfeat-analysis @ https://github.com/dukeofnemours/langfeat-analysis/releases/download/v0.2.4/langfeat_analysis-0.2.4-py3-none-any.whl'
```
...
```bash
curl -fL \
  https://raw.githubusercontent.com/dukeofnemours/langfeat-analysis/v0.2.4/configs/preproc.yaml.example \
  -o preproc.yaml
